<div class="navbar @if(($configData['isNavbarFixed'])=== true){{'navbar-fixed'}} @endif">
  <nav
    ...
    <div class="nav-wrapper">
      ...
      <!-- translation-button-->
      <ul class="dropdown-content" id="translation-dropdown" style="display:none;">
      ...
      <ul class="dropdown-content" id="notifications-dropdown" style="display:none;">
        <li>
      ...
      <ul class="dropdown-content" id="profile-dropdown">
        ...
        <li>
          <a class="grey-text text-darken-1" href="{{asset('user-logout')}}">
...
<!-- search ul  -->
<ul class="display-none" id="default-search-main" style="display:none;">
...
<ul class="display-none" id="page-search-title" style="display:none;">
  <li class="auto-suggestion-title">
    <a class="collection-item" href="#">
...
<ul class="display-none" id="search-not-found" style="display:none;">
  <li class="auto-suggestion">
