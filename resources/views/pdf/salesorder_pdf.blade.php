...
<body>
    ...
    <table width=100%>
        <tr>
            <td width=40%>
                <br />Order No.: {{ $content -> no }}
                {{-- <br />Cost Center: {{ shortenDescription($content -> costcentre) }} --}}
            </td>
            <td width=20%>
            </td>
            <td width=40%>
        ...
        <table border="0" width=100%>
            <thead>
                <tr>
                    ...
                    <th style="width:10%; height: 30px; background-color: #000; color: #EEE;">UNIT PRICE</th>
                    <th style="width:10%; height: 30px; background-color: #000; color: #EEE;">TOTAL PRICE</th>
                </tr>
            </thead>
            ...
            <tbody class="useritem_tbody">
				...
				<td style="height: 20px; background-color: #ddd;text-align:center;">$ {{ ($item -> price * $item -> qty)}}</td>
				...
				<td colspan="2" style="height: 20px; background-color: #ddd;text-align:center;"> Sub Total Price </td>

				<td style="height: 20px; background-color: #ddd;text-align:center;">$ {{$sub_total }}</td>
