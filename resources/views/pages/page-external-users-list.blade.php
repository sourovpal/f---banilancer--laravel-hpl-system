...
{{-- page title --}}
@section('title','External Users List')
  ...
  <div class="users-list-table">
    <div class="card">
      <div class="card-content">
        <span class="card-title">External User</span>
        <!-- datatable start -->
            ...
            <tbody>
              @foreach($users as $user)
                <tr>
                  ...
                  <td>{{ $user -> admin_role ? 'Admin' : 'User' }}</td>
                  <td>
                    <?php
                      if ($user -> appr_role == 2) echo 'Manager';
                      else if ($user -> appr_role == 1) echo 'Approver';
                      else echo 'User';
                    ?>
                  </td>
                  ...
                  <td><a href="{{ asset('page-users-edit/' . $user -> id) }}">Edit</a> <a href="#confirm_modal" user_id="{{ $user -> id }}" class="delete_user modal-trigger">Delete</a></td>
                  <!-- <td><a href="{{ asset('page-users-delete/' . $user -> id) }}">delete</a></td> -->
                </tr>
              @endforeach
            </tbody>
          </table>
