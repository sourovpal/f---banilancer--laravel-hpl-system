...
{{-- page title --}}
@section('title','Create Small Order')
		   ...
		   <div class="col s12 m6">
            <select id="old_costcenter" name="costcenter">
              ...
              @foreach($costcenters as $costcenter)
                <option value="{{ $costcenter -> id }}" {{ (isset($data['cc_id']) && $data['cc_id'] == $costcenter -> id) ? 'selected' : '' }}>{{ $costcenter -> code }}</option>
              @endforeach
            </select>
            </div>
          ...
          <div id="add_item_modal" class="modal modal-fixed-footer">
            <div class="modal-content">
              <h4 class="mb-3">Add Item</h4>
                <form id="addItemForm" action="/quotationitem_add" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}

                    <div class="row">
                        <div class="col s12 m12 input-field">
                          <input id="itemname" name="itemname" type="text" class="validate" value="" data-error=".errorTxt1">
                    ...
                    <div class="row">
                        <div class="col s12 m12 input-field">
                          <input id="itemspecification" name="itemspecification" type="text" class="validate" data-error=".errorTxt2">
                    ...
                    <div class="row">
                        <div class="col s12 m6 input-field">
                          <input id="itemunit" name="itemunit" type="text" class="validate" value="" data-error=".errorTxt3">
                          <label for="itemunit">Item Unit</label>
                          <small class="errorTxt3"></small>
                        </div>
                        <div class="col s12 m6 input-field">
                          <input id="itempack" name="itempack" type="text" class="validate" value="" data-error=".errorTxt4">
                    ...
                    <div class="row">
                        <div class="col s12 m6 input-field">
                          <input id="itemqty" name="itemqty" type="text" class="validate" value="" data-error=".errorTxt5">
                        ...
                        <input id="itemprice" name="itemprice" type="hidden" class="validate" value="0" data-error=".errorTxt6">
                    </div>
                    <div class="row">
                        <div class="col s12 m6 input-field">
            ...
            <tbody>
              @foreach($quotationitems as $quotationitem)
                <tr>
                  ...
                  <td><a href="{{ asset('quotation_item_delete/' . $quotationitem -> id) }}">Cancel</a></td>
                </tr>
              @endforeach
            </tbody>
          </table>
