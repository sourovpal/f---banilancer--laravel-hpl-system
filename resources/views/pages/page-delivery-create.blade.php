...
{{-- page title --}}
@section('title','Create Delivery Note Record')
...
<section class="users-list-wrapper section">
  <div class="users-list-table">
            ...
            <div class="modal-content">
              ...
              <div class="row mt-3 mb-5">
                ...
                <div class="col s12 m4">
                  ...
                  <input id="search_description" name="search_description" type="text">
                </div>
              </div>
              <table id="modal_item" class="table" style="width:100%;">
                <thead>
                  <tr>
                    <th>
                      <label>
          ...
          <table id="item_table" class="users-list-datatable table">
            ...
            <tbody>
              <tr>
                ...
                <td>3</td>
                <td></td>
                <td><a href="javascript:;"><i class="material-icons">cancel</i></a></td>
              </tr>
              <tr>
                <td>WA-3814</td>
                <td>HIROTA ALCOHOL SWAB</td>
    ...
    <div class="card">
      <div class="card-content">
        <div class="media display-flex align-items-center">
          <span class="card-title">Delivery Note Remarks:</span>
        </div>
