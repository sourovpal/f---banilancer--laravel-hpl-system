          ...
          <div class="row">
            ...
            <div class="col s12 m6">
              ...
              <select id="supplier" name="supplier">
                ...
                {{-- <option value="{{ $supplier -> id }}">{{ $supplier -> code }} {{ $supplier -> englishname }} {{ $supplier -> chinaname }}</option> --}}
                <option value="{{ $supplier -> id }}">{{ $supplier -> code }} {{ $supplier -> englishname }} </option>
                @endforeach
              </select>
            </div>
          </div>
