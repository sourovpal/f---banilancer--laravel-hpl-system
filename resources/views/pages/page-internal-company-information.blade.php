...
{{-- page title --}}
@section('title','Internal Company Information')
  ...
  <div class="card">
    <div class="card-content">
      <div class="media display-flex align-items-center mb-2">
        <h5 class="media-heading mt-0">Interanl Company Information</h5>
      </div>
      <form id="internalCompanyInformationForm" class="userForm" action="/company_information_update" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="row">
          <div class="col s12 m12">
            <h5 class="media-heading mt-0">SMTP Credentials Setup</h5>
          </div>
        </div>
        <div class="row">
          <div class="col s12 m6 input-field">
            <input id="mail_driver" name="mail_driver" type="text" class="" value="{{ env('MAIL_DRIVER') }}">
            <label for="mail_driver">Mail Driver</label>
          </div>
          <div class="col s12 m6 input-field">
            <input id="mail_host" name="mail_host" type="text" class="" value="{{ env('MAIL_HOST') }}">
            <label for="mail_host">Mail Host</label>
          </div>
          <div class="col s12 m6 input-field">
            <input id="mail_port" name="mail_port" type="text" class="" value="{{ env('MAIL_PORT') }}">
            <label for="mail_port">Mail Port</label>
          </div>
          <div class="col s12 m6 input-field">
            <input id="mail_username" name="mail_username" type="text" class="" value="{{ env('MAIL_USERNAME') }}">
            <label for="mail_username">Mail Username</label>
          </div>
          <div class="col s12 m6 input-field">
            <input id="mail_password" name="mail_password" type="text" class="" value="{{ env('MAIL_PASSWORD') }}">
            <label for="mail_password">Mail Password</label>
          </div>
          <div class="col s12 m6 input-field">
            <input id="mail_encryption" name="mail_encryption" type="text" class="" value="{{ env('MAIL_ENCRYPTION') }}">
