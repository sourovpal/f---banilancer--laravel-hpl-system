...
{{-- page title --}}
@section('title','Update Category Record')
      ...
      <div class="card-content">
        <div class="row">
          <div class="col s12" id="account">
            ...
            <form id="categoryUpdateForm" action="/category_update" method="post">
              {{ csrf_field() }}

              <div class="row">
                <div class="col s12 input-field">
                  <input type="hidden" name="id" value="{{ $category -> id }}">
                  <input id="categorycode" name="categorycode" type="text" class="validate" value="{{ $category -> code }}" data-error=".errorTxt1">
                  <label for="categorycode">Category Code</label>
                  <small class="errorTxt1"></small>
                </div>
                <div class="col s12 input-field">
                  <input id="categoryname" name="categoryname" type="text" class="validate" value="{{ $category -> name }}" data-error=".errorTxt2">
...
<script src="{{asset('js/scripts/page-category.js')}}"></script>
<script>
