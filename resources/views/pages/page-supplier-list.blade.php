...
{{-- page title --}}
@section('title','Current Supplier List')
          ...
          <table id="users-list-datatable" class="users-list-datatable table">
            ...
            <tbody>
              @foreach($suppliers as $supplier)
                <tr>
                  <td>{{ $supplier -> code }}</td>
                  <td>{{ $supplier -> englishname }}</td>
                  <td>{{ $supplier -> chinaname }}</td>
                  <td>{{ $supplier -> email }}</td>
                  <td>{{ $supplier -> englishaddress }}</td>
                  <td>{{ $supplier -> chinaaddress }}</td>
                  ...
                  <td><a href="{{asset('/update-supplier-record/' . $supplier -> id)}}">Edit</a></td>
                </tr>
              @endforeach
            </tbody>
          </table>
