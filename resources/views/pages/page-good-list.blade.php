              ...
              <!--<td>{{ $goodreceive['remarks'] }}</td>-->
                  ...
                  <td>
                    @if (Auth::user() -> role == 'master' || Auth::user() -> role == 'internal')
                      <!--<a class="ml-5" href="{{asset('/complete-good-receive-record/' . $goodreceive['id'])}}">Completed <i class="material-icons">edit</i> </a>-->
                      <a class="ml-5" href="{{asset('/update-good-receive-record/' . $goodreceive['id'])}}">Edit <!-- <i class="material-icons">edit</i> --></a>
                      <a class="ml-5" href="{{asset('/cancel-good-receive-record/' . $goodreceive['id'])}}">Cancel <!-- <i class="material-icons">close</i> --></a>
 @endif
                  </td>
                </tr>
