      ...
      <div class="card-content">
        <div class="row">
          <div class="col s12" id="account">
            ...
            <form id="costcenterRegisterForm" action="/costcenter_register" method="post">
              {{ csrf_field() }}
              
              <div class="row">
                <div class="col s12 m6 input-field">
                  <input id="costcentername" name="costcentername" type="text" class="validate" value="" data-error=".errorTxt1">
                  <label for="costcentername">Costcenter Name</label>
                  <small class="errorTxt1"></small>
                </div>
                <div class="col s12 m6 input-field">
                  <input id="costcentercode" name="costcentercode" type="text" class="validate" value="" data-error=".errorTxt2">
                  <label for="costcentercode">Costcenter Code</label>
                  <small class="errorTxt2"></small>
                </div>
                  <div class="col s12 m6 input-field">
                                        <input id="floor" name="floor" type="text" class="validate" value=""
                                            data-error=".errorTxt2">
                                        <label for="floor">Floor</label>
                                        <small class="errorTxt2"></small>
                                    </div>
                                    <div class="col s12 m6 input-field">
                                        <input id="build" name="build" type="text" class="validate" value=""
                                            data-error=".errorTxt2">
