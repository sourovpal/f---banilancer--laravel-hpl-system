      ...
      <div class="card-content">
        <div class="row">
          <div class="col s12" id="account">
            ...
            <form id="supplierRegisterForm" action="/supplier_register" method="post">
              {{ csrf_field() }}
              ...
              <div class="row">
                <div class="col s12 m6">
                  <div class="row">
                    <div class="col s12 input-field">
                      <input id="suppliercode" name="suppliercode" type="text" class="validate" value=""
                        data-error=".errorTxt1">
                      <label for="suppliercode">Supplier Code</label>
                      <small class="errorTxt1"></small>
                    </div>
                    <div class="col s12 input-field mt-2">
                      <input id="englishname" name="englishname" type="text" class="validate" value=""
                        data-error=".errorTxt3">
                      <label for="englishname">English Name</label>
                      <small class="errorTxt3"></small>
                    </div>
                    <div class="col s12 input-field">
                      <input id="englishaddress" name="englishaddress" type="text" class="validate" value=""
                        data-error=".errorTxt5">
                      <label for="englishaddress">English Address</label>
                      <small class="errorTxt5"></small>
                    </div>
                    <div class="col s12 input-field">
                      <input id="telephone1" name="telephone1" type="text" class="validate" value=""
                        data-error=".errorTxt7">
                      <label for="telephone1">Telephone 1</label>
                      <small class="errorTxt7"></small>
                    </div>
                    <div class="col s12 input-field">
                      <input id="suppliercontact" name="suppliercontact" type="text" class="validate" value=""
                        data-error=".errorTxt9">
                      <label for="suppliercontact">Supplier Contact</label>
                      <small class="errorTxt9"></small>
                    </div>
                    <div class="col s12 input-field">
                      <input id="suppliermobile" name="suppliermobile" type="text" class="validate" value=""
                ...
                <div class="col s12 m6">
                  <div class="row">
                    <div class="col s12 input-field">
                      <input id="supplieremail" name="supplieremail" type="text" class="validate" value=""
                        data-error=".errorTxt2">
                      <label for="supplieremail">Supplier Email</label>
                      <small class="errorTxt2"></small>
                    </div>
                    <div class="col s12 input-field">
                      <input id="chinaname" name="chinaname" type="text" class="validate" value=""
                        data-error=".errorTxt4">
                      <label for="chinaname">Chinese Name</label>
                      <small class="errorTxt4"></small>
                    </div>
                    <div class="col s12 input-field">
                      <input id="chinaaddress" name="chinaaddress" type="text" class="validate" value=""
                        data-error=".errorTxt6">
                      <label for="chinaaddress">Chinese Address</label>
                      <small class="errorTxt6"></small>
                    </div>
                    <div class="col s12 input-field">
                      <input id="telephone2" name="telephone2" type="text" class="validate" value=""
                        data-error=".errorTxt8">
                      <label for="telephone2">Telephone 2</label>
                      <small class="errorTxt8"></small>
                    </div>
                    <div class="col s12 input-field">
                      <input id="supplierfax" name="supplierfax" type="text" class="validate" value=""
