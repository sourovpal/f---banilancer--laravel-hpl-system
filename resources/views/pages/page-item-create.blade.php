...
{{-- page title --}}
@section('title','Create Item Record')
    ...
    <div class="card-content">
      <div class="row">
        <div class="col s12" id="account">
          ...
          <form id="itemRegisterForm" action="/item_register" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="row">
                ...
                <div class="row">
                  <div class="col s12 input-field">
                    ...
                    @if ($error['error'] == 'category')
                      <small style="color: #FF4081;">Please Select a Category</small>
                    @endif
                  </div>
                  <div class="col s12 input-field mt-2">
                    <input id="itemcode" name="itemcode" type="text" class="validate" value=""
                  ...
                  <div class="col s12 input-field">
                    <input id="itemprice" name="itemprice" type="text" class="validate" value=""
                  ...
                  <!--
				  <div class="col s12 input-field">
                    <input id="itemmin" name="itemmin" type="text" class="validate" value=""
				  ...
				  -->
                  <div class="col s12 input-field">
                    <input id="itemgl" name="itemgl" type="text" class="validate" value=""
                      data-error=".errorTxt7">
                    <label for="itemgl">GL</label>
              ...
              <div class="col s12 m6">
                <div class="row">
                  <div class="col s12 input-field" style="margin-top: 0px;">
                    <div class="file-field input-field">
                      ...
                      <div class="file-path-wrapper">
                        <input style="width: -webkit-fill-available;" class="file-path validate" type="text" value="">
                        <img id="imagePreview" src="#" alt="Preview Image" style="display: none;width: 41%">
                      </div>
                      @if ($error['error'] == 'image')
                        <small style="color: #FF4081;">The image is required.</small>
                      @endif
                    </div>
                  </div>
                  <div class="col s12 input-field" style="margin-top: 0px;">
                  ...
                  <div class="col s12 input-field">
                    <input id="itemlocation" name="itemlocation" type="text" class="validate" value=""
