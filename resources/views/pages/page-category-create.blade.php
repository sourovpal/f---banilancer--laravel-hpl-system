...
{{-- page title --}}
@section('title','Create Category Record')
      ...
      <div class="card-content">
        <div class="row">
          <div class="col s12" id="account">
            ...
            <form id="categoryRegisterForm" action="/category_register" method="post">
              {{ csrf_field() }}
              
              <div class="row">
                <div class="col s12 input-field">
                  <input id="categorycode" name="categorycode" type="text" class="validate" value="" data-error=".errorTxt1">
                  <label for="categorycode">Category Code</label>
                  <small class="errorTxt1"></small>
                </div>
                <div class="col s12 input-field">
                  <input id="categoryname" name="categoryname" type="text" class="validate" value="" data-error=".errorTxt2">
