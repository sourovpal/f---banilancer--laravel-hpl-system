      ...
      <div class="card-content">
        <div class="row">
          <div class="col s12" id="account">
            ...
            <form id="departmentUpdateForm" action="/department_update" method="post">
              {{ csrf_field() }}

              <div class="row">
                <div class="col s12 m6 input-field">
                  <input type="hidden" name="id" id="id" value="{{ $department -> id }}">
                  <input id="departmentname" name="departmentname" type="text" class="validate" value="{{ $department -> name }}" data-error=".errorTxt1">
                  <label for="departmentname">Department Name</label>
                  <small class="errorTxt1"></small>
                </div>
                <div class="col s12 m6 input-field">
                  <input id="departmentcode" name="departmentcode" type="text" class="validate" value="{{ $department -> code }}" data-error=".errorTxt2">
                  <label for="departmentcode">Department Code</label>
                  <small class="errorTxt2"></small>
                </div>
               <!--  <div class="col s12 m6 input-field">
                  <input id="floor" name="floor" type="text" class="validate" value="{{ $department -> floor }}" data-error=".errorTxt2">
                  <label for="floor">Floor</label>
                  <small class="errorTxt2"></small>
                </div>
                <div class="col s12 m6 input-field">
                  <input id="build" name="build" type="text" class="validate" value="{{ $department -> build }}" data-error=".errorTxt2">
